...
# ydb333           [charles] Verifies that the output of $V("PROBECRIT"..) has values other than 0 and 1000 for CPT
#----------------------------------------------------------------------------------------------------------------------------------------------------------
...
setenv subtest_list_non_replic "$subtest_list_non_replic ydb324 ydb333"
